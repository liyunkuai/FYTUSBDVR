...
import com.syu.dvr.rk.CameraManager.CameraProxy;
...
public class CameraHolder {
    ...
    private int[] mCameraId;  // current camera id
            ...
            switch(msg.what) {
                case RELEASE_CAMERA:
                    synchronized (CameraHolder.this) {
                        ...
                        // here:
                        if (!mCameraOpened[msg.arg1]) release(msg.arg1);
                    }
                    break;
            }
        }
...
//        sHolder = new CameraHolder();
        ...
        if (mMockCameraInfo != null) {
            ...
            for (int i = 0; i < mNumberOfCameras; i++) {
                ...
                try {
                    ...
                    Log.w(TAG, "camera " + i + " maybe doesn't exist");
                }
                mCameraId[i] = -1;
            }
        }
    ...
    public int getNumberOfCameras() throws RuntimeException {
    ...
    public synchronized CameraProxy open(
        ...
        if (mCameraDevice[cameraId] == null) {
            ...
            if (mMockCameraInfo == null) {
                mCameraDevice[cameraId] = CameraManagerFactory
    ...
    public synchronized void release(int id) {
        ...
        if (now < mKeepBeforeTime) {
            ...
            mHandler.sendMessageDelayed(mHandler.obtainMessage(RELEASE_CAMERA, id, 0),
                    mKeepBeforeTime - now);
