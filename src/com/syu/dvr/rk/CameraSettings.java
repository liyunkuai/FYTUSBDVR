...
public class CameraSettings {
    ...
    public static final String KEY_BACK_VIDEO_QUALITY = "pref_back_video_quality_key";
    public static final String KEY_FRONT_VIDEO_QUALITY = "pref_front_video_quality_key";
    public static final String KEY_BACK_SUPPORT_VIDEO_QUALITYS = "pref_back_video_support_qualitys_key";
    public static final String KEY_FRONT_SUPPORT_VIDEO_QUALITYS = "pref_front_video_support_qualitys_key";
    public static final String KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL = "pref_video_time_lapse_frame_interval_key";
    public static final String KEY_BACK_PICTURE_SIZE = "pref_back_camera_picturesize_key";
    ...
    public static final String KEY_BACK_SUPPORT_PICTURE_SIZES = "pref_back_support_camera_picturesizes_key";
    public static final String KEY_FRONT_SUPPORT_PICTURE_SIZES = "pref_front_support_camera_picturesizes_key";
    public static final String KEY_JPEG_QUALITY = "pref_camera_jpegquality_key";
    public static final String KEY_FOCUS_MODE = "pref_camera_focusmode_key";
    public static final String KEY_FLASH_MODE = "pref_camera_flashmode_key";
    public static final String KEY_SHUTTER_MODE = "pref_camera_shuttermode_key";
    ...
    public static final String KEY_WHETHER_RECORDING = "pref_whether_recording";
    public static final String KEY_WHETHER_PREVIEW = "pref_whether_PREVIEW";
    ...
    private static final String TAG = "CAM_CameraSettings";
    ...
    public static void initialCameraPictureSize(
            Context context, @SuppressWarnings("deprecation") Parameters parameters, int cameraId) {
        ...
        List<String> supportedSizesList = sizeListToStringList(supported);
        for (String candidate : context.getResources().
                getStringArray(R.array.pref_camera_photo_quality_entry)) {
            if (setCameraPictureSize(candidate, supported, parameters)) {
                TheApp.mApp.savaString(cameraId == 
                    CameraHolder.instance().getBackCameraId() ? KEY_BACK_PICTURE_SIZE :
                    KEY_FRONT_PICTURE_SIZE, candidate);
                String supportSizes = "";
                for (int i = 0; i < supportedSizesList.size(); i++) {
                    if (i == (supportedSizesList.size() - 1))
                        supportSizes += supportedSizesList.get(i);
                    else
                        supportSizes += supportedSizesList.get(i) + ",";
                }
                TheApp.mApp.savaString(cameraId == 
                    CameraHolder.instance().getBackCameraId() ? KEY_BACK_SUPPORT_PICTURE_SIZES :
                    KEY_FRONT_SUPPORT_PICTURE_SIZES, supportSizes);
                return;
            }
        }
    ...
    /*private void initPreference(PreferenceGroup group) {
        ...
        ListPreference shutterMode = group.findPreference(KEY_SHUTTER_MODE);
    ...
    public static String[] sizeListToStringArray(List<Size> sizes) {
        if (sizes == null) return null;
        String[] array = new String[sizes.size()];
        for (int i = 0; i < sizes.size(); i++) {
            array[i] = String.format(Locale.ENGLISH, "%dx%d", sizes.get(i).width, sizes.get(i).height);
        }
        return array;
    }

    public static List<Point> StringArrayTosizeList(String[] array) {
        if (array == null) return null;
        ArrayList<Point> list = new ArrayList<Point>();
        for (String size : array) {
